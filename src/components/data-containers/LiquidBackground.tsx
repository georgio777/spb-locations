 ...
 * 
 * @example
 * <LiquidBackground elementTag="section" className="my-class">
 *   <p>Контент на стеклянном фоне</p>
 * </LiquidBackground>
 * 
 * @param {LiquidBackgroundProps} props - Свойства компонента.
...
export const LiquidBackground = ({
  ...
  return (
    <ElementTag 
      className={`bg-liquid-glass ${className}`}
      style={style}
    >
      {children}
    </ElementTag>
